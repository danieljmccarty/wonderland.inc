...
public class Manager2 : MonoBehaviour
{
    ...
    void GameCompleteSequence()
    {
        if (currentTime >= 6)
        {
            ...
            SceneManager.LoadScene("shift 2 complete");
        }
    ...
    public void GoForward()
    {
        ...
        {
            currentSceneIndex = 51;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        else if (currentSceneIndex == 51)
        {
            currentSceneIndex = 54;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
            else if (currentSceneIndex == 54)
            {
                currentSceneIndex = 57;
                sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
            }
            else if (currentSceneIndex == 57)
            {
                currentSceneIndex = 60;
                sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
    }
    public void GoBack()
    ...
    public void GoLeft()
    {
        ...
        {
            currentSceneIndex = 55;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        else if (currentSceneIndex == 56)
        {
            currentSceneIndex = 54;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        ...
        {
            currentSceneIndex = 58;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        else if (currentSceneIndex == 59)
        {
            currentSceneIndex = 57;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
    ...
    public void GoRight()
    {
        ...
        {
            currentSceneIndex = 53;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        else if (currentSceneIndex == 55)
        {
                currentSceneIndex = 54;
                sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        ...
        {
            currentSceneIndex = 56;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
        else if (currentSceneIndex == 58)
        {
            currentSceneIndex = 57;
            sceneSpriteRenderer.sprite = sceneSprites[currentSceneIndex];
        }
